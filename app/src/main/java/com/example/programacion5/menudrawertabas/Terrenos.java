 ...
 */
public class Terrenos extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_terrenos, container, false);
    ...
    public class ViewPagerAdapter extends FragmentStatePagerAdapter {
        ...
        String[] titulo = {"Terrenos ", "Ubicacion", "Vista"};
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                ...
                case 0: ListaTerrenos tdos = new ListaTerrenos();  return tdos;
                case 1: TabTMapas tuno = new TabTMapas();          return tuno;
                case 2: VistaTerrenos ttres = new VistaTerrenos(); return ttres;
            }
            return null;
        }
